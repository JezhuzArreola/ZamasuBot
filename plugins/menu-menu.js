...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const fkon = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': wm, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${wm},;;;\nFN:${wm},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, 'jpegThumbnail': imagen1, thumbnail: imagen1 ,sendEphemeral: true}}};
    await conn.reply(m.chat, '𝙀𝙨𝙥𝙚𝙧𝙖 𝙃𝙪𝙢𝙖𝙣𝙤 𝙚𝙨𝙩𝙖𝙢𝙤𝙨 𝙚𝙣𝙫𝙞𝙖𝙣𝙙𝙤 𝙚𝙡 𝗺𝗲𝗻𝘂📍. . .',m, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '🌟 𝗛𝗼𝗹𝗮 𝗵𝘂𝗺𝗮𝗻𝗼!!', body: 'bienvenido', sourceUrl: global.md, thumbnail: await (await fetch(pp)).buffer() }}})
//m.react('💫');
    await conn.sendMessage(m.chat, { react: { text: '✨', key: m.key } })
  let txt =`┏•─────✧─────••
┣┅⟣👒 𝗛𝗼𝗹𝗮👋, 𝗦𝗼𝘆 𝗭𝗮𝗺𝗮𝘀𝘂𝗕𝗼𝘁𝗟𝗶𝘁𝗲-𝗠𝗗
┣┅⟣👒 𝗘𝗻 𝗴𝗿𝘂𝗽𝗼𝘀: 𝙾𝚆𝙽𝙴𝚁  
┣┅⟣👒 𝗢𝘄𝗻𝗲𝗿: 𝙹𝙾𝚂𝙴
┣┅⟣👒 𝗡𝘂𝗺𝗲𝗿𝗼:+51 975 985 721
┣┅⟣👒 𝗙𝗲𝗰𝗵𝗮: ${date}
┣┅⟣👒 𝗨𝗡 𝗣𝗟𝗔𝗖𝗘𝗥 𝗖𝗢𝗡𝗢𝗦𝗘𝗥𝗧𝗘
┗•─────✧─────•┛
...
┏•━•━•━ ◎ ━•━•━•┓
┃ ⏤͟͟͞͞𝑼𝑵𝑬 𝑨 𝒁𝑨𝑴𝑨𝑺-𝑩𝑶𝑻 𝑨 𝑻𝑼 𝑮𝑹𝑼𝑷𝑶
┗──── ◉ ────━━
...
┣🎈 𝐦𝐞𝐧𝐮𝐨𝐰𝐧𝐞𝐫
┗•━•━•━ ◎ ━•━•━•┛`;
   await conn.sendMessage(m.chat, {text: txt.trim(), mentions: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: {forwardingScore: 9999999, isForwarded: true, mentionedJid: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "renderLargerThumbnail": true, "title": '☆ 𝐙𝐀𝐌𝐀𝐒 𝐁𝐎𝐓 𝐌𝐃 ☆', "containsAutoReply": true, "mediaType": 1, "thumbnail": [imagen6,imagen1,imagen4].getRandom(), "mediaUrl": global.gp1, "sourceUrl": global.gp1}}}, {quoted: fkon});
 // m.react('💖');
  } catch {
