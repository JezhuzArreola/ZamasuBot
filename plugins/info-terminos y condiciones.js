...
_- El chat anonimo del comando #start, valga la redundancia no mostrará ningun dato de los Usuarios por parte de Zamasu-Bot-MD. Eso no implica que las personas que hagan uso de esta funcion puedan dar a conocer sus datos. en Numero(s) Oficial(es)._

_- Los Datos que Obtenga Lobo-bot-MD en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en optimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensacion Por el numero wa.me/51975985721 o por el comando #Reporte. Debe de Presentar Pruebas)._
...
🧸𝗧𝗲 𝗮𝘀 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝗱𝗼 𝘀𝗼𝗯𝗿𝗲 𝗭𝗮𝗺𝗮𝘀𝘂𝗕𝗼𝘁𝗟𝗶𝘁𝗲-𝗠𝗗`.trim()
